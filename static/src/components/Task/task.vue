    ...
    <div class="event_input" v-if="display">
      ...
      <div class="taskNav">
        ...
        <div class="time">
          ...
          <!--时长-->
          <!--<div class="page-datetime timeLength" v-if="timeVisable">-->
            <!--<div class="page-datetime-wrapper">-->
              <!--<span>时长：</span>-->
              <!--<mt-button @click.native="open('picker2')" v-text="value3" size="large"></mt-button>-->
              <!--<mt-datetime-picker-->
                <!--ref="picker2"-->
                <!--type="time"-->
                <!--v-model="value2"-->
  ...
  export default {
    ...
    methods: {
      ...
      confirmAdd (){
        ...
        this.elDisply = true
        this.startTime.toString().substring(0,9)
        ...
        axios({
          method: 'post',
          url: 'http://www.todobest.tk/api/task/create',
          data: postData,
          headers: {
            Authorization: this.token
          }
      ...
      //   console.log("选项值已改变")
        ...
        axios({
          method: 'post',
          data: data,
          url: 'http://www.todobest.tk/api/task/finish',
          headers: {
            Authorization: this.token
          }
        })
      ...
      addList (index,taskId) {
        ...
        axios({
          method:'post',
          url:'http://www.todobest.tk/api/task/unfinish',
          data:data,
          headers: {
            Authorization: this.token
          }
      ...
      delUncheck: function(name, idx, taskId){
        if(confirm("确认删除"+ name)){
          ...
          axios({
            method:'delete',
            url:'http://www.todobest.tk/api/task/delete',
            data: data,
            headers: {
              Authorization: this.token
            }
